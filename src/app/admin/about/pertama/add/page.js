...
const AddPage = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            // Get all documents in the "pertama" collection
            const q = query(collection(db, "pertama"));
            ...
            await addDoc(collection(db, "pertama"), {
                id: newId,
                gambar: imageUrl,
            ...
            .then(() => {
                resetForm();
                setPreview(null);
                router.push('/admin/about/pertama');
...
export default authCheck(AddPage);
