...
const AddPage = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            // Get all documents in the "keempat" collection
            const q = query(collection(db, "keempat"));
            ...
            await addDoc(collection(db, "keempat"), {
                id: newId,
                gambar: imageUrl,
            ...
            .then(() => {
                resetForm();
                setPreview(null);
                router.push('/admin/about/keempat');
