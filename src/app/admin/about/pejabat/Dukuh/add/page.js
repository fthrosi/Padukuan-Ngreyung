...
const AddDukuhPage = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            // Get all documents in the "dukuh" collection
            const q = query(collection(db, "dukuh"));
            ...
            await addDoc(collection(db, "dukuh"), {
                id: newId,
                gambar: imageUrl,
            ...
            .then(() => {
                resetForm();
                setPreview(null);
                router.push('/admin/about/pejabat/Dukuh');
...
export default authCheck(AddDukuhPage);
