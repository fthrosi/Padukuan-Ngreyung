        ...
        { image: '/images/home.jpg', speed: -50 },
        {
          ...
          children: (
            <div className="absolute inset-0 items-center justify-center text-center text-white flex flex-col p-4">
              ...
              <h1 className="text-base  md:text-2xl lg:text-2xl md:mt-6 lg:mt-10 font-bold">Dhadio Tulodho Nyengkuyung Gegayuhan</h1>
            </div>
          ),
        },
      ]}
      className="lg:aspect-[2/1.1] md:aspect-[1/1.5] aspect-[1/2.5]"
    />
  );
};
